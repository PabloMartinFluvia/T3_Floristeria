...
public abstract class LocalIncrementosC2 extends LocalPersistenciaC2 implements IncrementosC2 {

    protected ProductoUnidad2 productoUnidadSeleccionado;
    ...
    public LocalIncrementosC2(Manager2 manager) {
        super(manager);
    }
    ...
    public void resetModels() {
        productoUnidadSeleccionado = new ProductoUnidad2();
    }
    ...
    protected int getOldCantidad() {
        return productoUnidadSeleccionado.getCantidad();
    }
    ...
    protected int getStockId() {
        return productoUnidadSeleccionado.getProducto().categoriaIndex() + 1;
    }

    @Override
    public void setModelsNull() {
        productoUnidadSeleccionado = null;
    }
