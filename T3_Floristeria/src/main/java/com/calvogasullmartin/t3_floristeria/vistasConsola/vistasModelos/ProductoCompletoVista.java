...
import com.calvogasullmartin.t3_floristeria.vistasConsola.auxiliares.UnaOpcionCategoriaVista;
...
public class ProductoCompletoVista extends UnaOpcionCategoriaVista{        
    ...
    //private NuevoProductoControlador controlador;

    public ProductoCompletoVista() {        
    }
        
    public void requerirNuevoProducto(NuevoProductoControlador controlador){   
        //el id no se pide
