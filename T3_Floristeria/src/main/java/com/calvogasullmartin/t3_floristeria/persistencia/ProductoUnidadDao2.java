...
public interface ProductoUnidadDao2 extends GenericDao2<ProductoUnidad2, Integer>{
    ...
    */
    public void actualizarUnidadesProductoByStockId(ProductoUnidad2 producto, int idConjunto) throws IOException;//ok
